...
import com.xu.appbaseui.richtext.CacheType;
...
import com.xu.appbaseui.richtext.ext.Base64;
import com.xu.appbaseui.richtext.ext.TextKit;
...
public class DefaultImageGetter implements ImageGetter, ImageLoadNotify {
    ...
    private static final int TASK_TAG = R.id.base_default_image_tag_id;
