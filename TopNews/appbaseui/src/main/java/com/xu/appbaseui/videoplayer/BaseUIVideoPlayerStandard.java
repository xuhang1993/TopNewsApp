 ...
 * On 2016/04/18 16:15
 */
public class BaseUIVideoPlayerStandard extends BaseUIVideoPlayer {
    ...
    public BaseUIVideoPlayerStandard(Context context) {
        super(context);
    }

    public BaseUIVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            fullscreenButton.setImageResource(R.drawable.base_shrink);
            ...
            fullscreenButton.setImageResource(R.drawable.base_enlarge);
    ...
    public int getLayoutId() {
        return R.layout.base_layout_standard;
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(BaseUIUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                if (!url.startsWith("file") && !url.startsWith("/") &&
                        !BaseUIUtils.isWifiConnected(getContext()) && !WIFI_TIP_DIALOG_SHOWED) {
                    showWifiDialog();
                    return;
                }
                startVideo();
    ...
    public void startVideo() {
        prepareMediaPlayer();
        onEvent(BaseUIUserActionStandard.ON_CLICK_START_THUMB);
    }
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            startButton.setImageResource(R.drawable.base_click_pause_selector);
        } else if (currentState == CURRENT_STATE_ERROR) {
            startButton.setImageResource(R.drawable.base_click_error_selector);
        } else {
            startButton.setImageResource(R.drawable.base_click_play_selector);
        }
    }
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.base_dialog_progress, null);
        ...
        if (deltaX > 0) {
            mDialogIcon.setBackgroundResource(R.drawable.base_forward_icon);
        } else {
            mDialogIcon.setBackgroundResource(R.drawable.base_backward_icon);
        }
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.base_dialog_volume, null);
        ...
        if (volumePercent <= 0) {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.base_close_volume);
        } else {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.base_add_volume);
        }
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        ...
        if (mBrightnessDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.base_dialog_brightness, null);
