 ...
 * On 2016/06/02 00:01
 */
public class BaseUIResizeTextureView extends TextureView {
    protected static final String TAG = "JCResizeTextureView";

    // x as width, y as height
    protected Point mVideoSize;

    public BaseUIResizeTextureView(Context context) {
        super(context);
        init();
    }

    public BaseUIResizeTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
