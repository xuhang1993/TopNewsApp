...
package com.xu.appbaseui.bottomnavigationbar.navigationbar;
...
import com.xu.appbaseui.bottomnavigationbar.behavior.XuBaseNavigationTabBarBehavior;
...
public class XuBaseNavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected XuBaseNavigationTabBarBehavior mBehavior;
    ...
    public XuBaseNavigationTabBar(final Context context) {
        this(context, null);
    }

    public XuBaseNavigationTabBar(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressWarnings({"ResourceAsColor", "ResourceType"})
    public XuBaseNavigationTabBar(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        final TypedArray typedArray =
                context.obtainStyledAttributes(attrs, R.styleable.XuBaseNavigationTabBar);
        try {
            setIsTitled(typedArray.getBoolean(R.styleable.XuBaseNavigationTabBar_ntb_titled, false));
            setIsBadged(typedArray.getBoolean(R.styleable.XuBaseNavigationTabBar_ntb_badged, false));
            setIsScaled(typedArray.getBoolean(R.styleable.XuBaseNavigationTabBar_ntb_scaled, true));
            setIsTinted(typedArray.getBoolean(R.styleable.XuBaseNavigationTabBar_ntb_tinted, true));
            setIsSwiped(typedArray.getBoolean(R.styleable.XuBaseNavigationTabBar_ntb_swiped, true));
            setTitleSize(
                    typedArray.getDimension(R.styleable.XuBaseNavigationTabBar_ntb_title_size, AUTO_SIZE)
            );
            setIsBadgeUseTypeface(
                    typedArray.getBoolean(
                            R.styleable.XuBaseNavigationTabBar_ntb_badge_use_typeface,
                            false
                    )
            );
            ...
            setTitleMode(
                    typedArray.getInt(
                            R.styleable.XuBaseNavigationTabBar_ntb_title_mode, TitleMode.ALL_INDEX
                    )
            );
            setBadgeSize(
                    typedArray.getDimension(R.styleable.XuBaseNavigationTabBar_ntb_badge_size, AUTO_SIZE)
            );
            setBadgePosition(
                    typedArray.getInt(
                            R.styleable.XuBaseNavigationTabBar_ntb_badge_position,
                            BadgePosition.RIGHT_INDEX
                    )
            );
            setBadgeGravity(
                    typedArray.getInt(
                            R.styleable.XuBaseNavigationTabBar_ntb_badge_gravity, BadgeGravity.TOP_INDEX
                    )
            );
            setBadgeBgColor(
                    typedArray.getColor(R.styleable.XuBaseNavigationTabBar_ntb_badge_bg_color, AUTO_COLOR)
            );
            setBadgeTitleColor(
                    typedArray.getColor(
                            R.styleable.XuBaseNavigationTabBar_ntb_badge_title_color, AUTO_COLOR
                    )
            );

            setTypeface(typedArray.getString(R.styleable.XuBaseNavigationTabBar_ntb_typeface));
            setInactiveColor(
                    typedArray.getColor(
                            R.styleable.XuBaseNavigationTabBar_ntb_inactive_color, DEFAULT_INACTIVE_COLOR
                    )
            );
            setActiveColor(
                    typedArray.getColor(
                            R.styleable.XuBaseNavigationTabBar_ntb_active_color, DEFAULT_ACTIVE_COLOR
                    )
            );
            setBgColor(
                    typedArray.getColor(
                            R.styleable.XuBaseNavigationTabBar_ntb_bg_color, DEFAULT_BG_COLOR
                    )
            );
            setAnimationDuration(
                    typedArray.getInteger(
                            R.styleable.XuBaseNavigationTabBar_ntb_animation_duration,
                            DEFAULT_ANIMATION_DURATION
                    )
            );
            setCornersRadius(
                    typedArray.getDimension(R.styleable.XuBaseNavigationTabBar_ntb_corners_radius, 0.0F)
            );
            setIconSizeFraction(
                    typedArray.getFloat(
                            R.styleable.XuBaseNavigationTabBar_ntb_icon_size_fraction,
                            AUTO_SCALE
                    )
            );
            ...
            if (isInEditMode()) {
                ...
                try {
                    final int previewColorsId = typedArray.getResourceId(
                            R.styleable.XuBaseNavigationTabBar_ntb_preview_colors, 0
                    );
    ...
    public void setBehaviorEnabled(final boolean enabled) {
        ...
        if (getParent() != null && getParent() instanceof CoordinatorLayout) {
            ...
            if (mBehavior == null) mBehavior = new XuBaseNavigationTabBarBehavior(enabled);
...
//        }
    ...
    protected float clampValue(final float value) {
        return Math.max(
                Math.min(value, XuBaseNavigationTabBar.MAX_FRACTION), XuBaseNavigationTabBar.MIN_FRACTION
        );
    }
