...
public class XuBaseRotate3dAnimation extends Animation {
    ...
    public XuBaseRotate3dAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public XuBaseRotate3dAnimation(int rollType, float fromDegrees, float toDegrees) {
        mRollType = rollType;
    ...
    public XuBaseRotate3dAnimation(int rollType, float fromDegrees, float toDegrees, float pivotX, float pivotY) {
        mRollType = rollType;
        mFromDegrees = fromDegrees;
        mToDegrees = toDegrees;
    ...
    public XuBaseRotate3dAnimation(int rollType, float fromDegrees, float toDegrees, int pivotXType, float pivotXValue, int pivotYType, float pivotYValue) {
        mRollType = rollType;
        mFromDegrees = fromDegrees;
        mToDegrees = toDegrees;
