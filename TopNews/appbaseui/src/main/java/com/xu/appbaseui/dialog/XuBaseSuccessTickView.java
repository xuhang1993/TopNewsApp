...
public class XuBaseSuccessTickView extends View {
    ...
    public XuBaseSuccessTickView(Context context) {
        super(context);
        init();
    }

    public XuBaseSuccessTickView(Context context, AttributeSet attrs){
        super(context,attrs);
        init();
    }
