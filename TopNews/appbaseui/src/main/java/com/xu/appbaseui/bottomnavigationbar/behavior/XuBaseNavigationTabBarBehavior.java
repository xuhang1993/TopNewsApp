package com.xu.appbaseui.bottomnavigationbar.behavior;
...
public class XuBaseNavigationTabBarBehavior extends XuBaseVerticalScrollingBehavior<XuBaseNavigationTabBar> {
    ...
    public XuBaseNavigationTabBarBehavior(final boolean behaviorTranslationEnabled) {
        super();
        this.mBehaviorTranslationEnabled = behaviorTranslationEnabled;
    }

    @Override
    public boolean onLayoutChild(CoordinatorLayout parent, XuBaseNavigationTabBar child, int layoutDirection) {
        return super.onLayoutChild(parent, child, layoutDirection);
    }


    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, XuBaseNavigationTabBar child, View dependency) {
        return super.onDependentViewChanged(parent, child, dependency);
    }

    @Override
    public void onDependentViewRemoved(CoordinatorLayout parent, XuBaseNavigationTabBar child, View dependency) {
        super.onDependentViewRemoved(parent, child, dependency);
    }

    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, XuBaseNavigationTabBar child, View dependency) {
...
// This method is intentionally empty, because of override
    ...
    @Override
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, XuBaseNavigationTabBar child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
    ...
    @Override
    public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, XuBaseNavigationTabBar child, View directTargetChild, View target, int nestedScrollAxes) {
        return nestedScrollAxes == ViewCompat.SCROLL_AXIS_VERTICAL || super.onStartNestedScroll(coordinatorLayout, child, directTargetChild, target, nestedScrollAxes);
    }

    // Handle scroll direction
    private void handleDirection(XuBaseNavigationTabBar child, int scrollDirection) {
    ...
    // Animate offset
    private void animateOffset(final XuBaseNavigationTabBar child, final int offset, boolean forceAnimation, boolean withAnimation) {
    ...
    private void ensureOrCancelAnimator(final XuBaseNavigationTabBar child, boolean withAnimation) {
    ...
    // Manage animation for Android < KITKAT
    private void ensureOrCancelObjectAnimation(final XuBaseNavigationTabBar child, final int offset, boolean withAnimation) {
    ...
    public static XuBaseNavigationTabBarBehavior from(XuBaseNavigationTabBar view) {
        ...
        if (!(behavior instanceof XuBaseNavigationTabBarBehavior))
            throw new IllegalArgumentException(
                    "The view is not associated with XuBaseNavigationTabBarBehavior");

        return (XuBaseNavigationTabBarBehavior) behavior;
    }
    ...
    public void hideView(XuBaseNavigationTabBar view, int offset, boolean withAnimation) {
        if (!mHidden) {
            mHidden = true;
    ...
    public void resetOffset(XuBaseNavigationTabBar view, boolean withAnimation) {
        if (mHidden) {
            mHidden = false;
    ...
    private void updateSnackBar(final XuBaseNavigationTabBar child, View dependency) {
